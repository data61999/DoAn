...
namespace DoAn1.Areas.Admin.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        //{
        //    List<HoaDon> hd = context.HoaDon.ToList();
            
        //    foreach (var details in hd)
        //    {
        //        if(details.Ngay.Month == DateTime.Today.Month - 1)
        //        {
        //            List<CT_HoaDon> cthd = context.CT_HoaDon.Where(x => x.HoaDonID == details.HoaDonID).ToList();
        //        }
        //    }
